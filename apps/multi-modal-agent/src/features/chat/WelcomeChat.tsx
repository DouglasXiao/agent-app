...
import { Image, Video, Send, Paperclip } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-semibold text-gray-900 mb-2">Hello, what can I help?</h1>
          <p className="text-lg text-gray-600">Please send your task description and files to me</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card
            ...
            onClick={() => setMessage('分析报告摘要并识别正面和负面评价。')}
          >
          ...
          <Card
            className="p-4 cursor-pointer hover:shadow-md transition-shadow"
            onClick={() => setMessage('提取文本中的关键信息和主要观点。')}
          >
          ...
          <Card
            className="p-4 cursor-pointer hover:shadow-md transition-shadow"
            onClick={() => setMessage('对文本内容进行总结和归纳。')}
          >
